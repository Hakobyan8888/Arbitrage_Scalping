...
namespace FtxApi
{
    public class FtxRestApi
    {
        ...
        public async Task<string> GetMarketOrderBookAsync(string marketName, int depth = 20)
        {
        ...
        public async Task<string> PlaceOrderAsync(string instrument, SideType side, decimal price, OrderType orderType, decimal amount, bool reduceOnly = false)
        {
            var path = $"api/orders";
        ...
        public async Task<string> GetOrderStatusAsync(string id)
        {
        ...
        public async Task<string> ModifyOrderPriceAsync(string orderId, decimal triggerPrice)
        {
            var resultString = $"/orders/{orderId}/modify";

            var body = $"\"triggerPrice\": {triggerPrice},";

            var sign = GenerateSignature(HttpMethod.Post, resultString, body);
        ...
        public async Task<string> ModifyOrderSizeAsync(string orderId, decimal size)
        {
            var resultString = $"/orders/{orderId}/modify";
        ...
        public async Task<string> ModifyOrderAsync(string orderId, decimal size, decimal triggerPrice)
        {
            var resultString = $"/orders/{orderId}/modify";
